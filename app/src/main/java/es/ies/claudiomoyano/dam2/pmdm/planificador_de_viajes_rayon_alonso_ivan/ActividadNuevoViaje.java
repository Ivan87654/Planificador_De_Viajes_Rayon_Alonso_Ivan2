...
public class ActividadNuevoViaje extends AppCompatActivity {
    ...
    // Código para gestionar el resultado del permiso de cámara
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Valor inicial del texto del presupuesto
        txtPresupuestoValor.setText("Presupuesto: 0€");

        // Adaptador para el Spinner usando recursos XML
        ...
        // Evento al seleccionar una opción del Spinner
        ...
        edtHoraSalida.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // TimePickerDialog para seleccionar hora
        ...
        // Botón para seleccionar imagen solicitar permiso camara
    ...
    // Resultado de los permisos solicitados
    @Override
